...
public class Main extends JFrame implements ActionListener, KeyListener {
    ...
    JButton b0, b1, b2, b3, b4, b5, b6, b7, b8, b9, comma, plus, minus,
        ...
        if (!textField.getText().isEmpty()) {
            ...
            try {
                ...
                if (answer.isInfinite()) {
                    ...
                    historyNewText += format.format(answer).replace(',', '.');
                }
            } catch (Exception e) {
                textField.setText("Error");
                historyNewText += "Error";
    ...
    public void actionPerformed(ActionEvent e) {
        ...
        if (e.getSource() == b0) {
            ...
            String str = "<html>"
                    ...
                    + "<p><i>© Copyright 2020 Majd Talji - All Rights Reserved</i></p>"
                    + "</html>";
